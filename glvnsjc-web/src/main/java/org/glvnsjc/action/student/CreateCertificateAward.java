...
public class CreateCertificateAward
{
    ...
    private String getPrintedDate()
    {
        ...
        String awardDate = properties.getProperty( "award.city" ) + ", " + properties.getProperty( "award.day" ) + " "
            + cl.get( Calendar.DATE ) + " " + properties.getProperty( "award.month" ) + " "
            + ( cl.get( Calendar.MONTH ) + 1 ) + " " + properties.getProperty( "award.year" ) + " "
