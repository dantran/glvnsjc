...
/**
 * Singleton to cache a list of school years available in database It is load/reload at startup and
 * when GlobalConfig gets changed
 */
        ...
        throws HibernateException
    {
        ...
        try
        {
            ...
            for ( int i = 0; i < list.size(); ++i )
            {
                ...
                _options
                    .add( new LabelValueBean( list.get( i ).toString() + "-" + nextYear, list.get( i ).toString() ) );
