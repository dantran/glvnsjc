 ...
 *
 * $Id: Tomcat5xTestSetup.java,v 1.1 2006/07/06 21:15:27 danttran Exp $
 */
...
public class Tomcat5xTestSetup extends TestSetup {
    ...
    protected void setUp() throws Exception {
        ...
        configuration.addDeployable(getWAR("glvnsjc-web"));
    ...
    private WAR getWAR(String context) {
        return new WAR(localRepository + "/org/glvnsjc/"
                + context + "/" + version + "/"
                + context + "-" + version + ".war");
    }
